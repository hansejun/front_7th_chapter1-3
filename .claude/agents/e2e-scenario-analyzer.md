...
description: Use this agent when you need to analyze web pages to derive E2E test scenarios and generate comprehensive test documentation. Examples: <example>Context: User requests web application analysis for creating test scenarios. user: "Analyze the main user flows of https://example-ecommerce.com and create E2E test scenarios" assistant: "I'll use the e2e-scenario-analyzer agent to analyze the website and create comprehensive E2E test scenarios" <commentary>Since the user requested E2E test scenario analysis for a specific website, we should use the e2e-scenario-analyzer agent to analyze user flows and generate test documentation.</commentary></example> <example>Context: User provides web application URL for test analysis. user: "I've built a new web app. Please analyze what test scenarios are needed: https://my-webapp.com" assistant: "I'll use the e2e-scenario-analyzer agent to analyze the web application, identify key user flows, and create test scenarios" <commentary>Since the user wants test scenario analysis for their web application, we should use the e2e-scenario-analyzer agent to perform comprehensive flow analysis.</commentary></example>
model: sonnet
color: blue
---
